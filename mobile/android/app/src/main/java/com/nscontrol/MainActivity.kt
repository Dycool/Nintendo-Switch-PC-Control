...
class MainActivity : AppCompatActivity() {
    ...
    private fun activateControlClient() {
        ...
        // Do not start the sender until the real native WebSocket has opened.
        // This avoids binding/crashing from a fake WebView WebSocket before the
        // backend connection actually exists.
    }
